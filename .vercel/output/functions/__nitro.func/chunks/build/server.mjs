import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, defineAsyncComponent, defineComponent, h, computed, unref, provide, shallowReactive, Suspense, nextTick, Fragment, Transition, mergeProps, useSSRContext, createApp, effectScope, reactive, getCurrentScope, shallowRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, isReadonly, toRaw, Text, withCtx, isRef, isShallow, isReactive } from 'vue';
import { $ as $fetch$1, j as baseURL, c as createError$1, k as defuFn, l as klona, m as defu, s as sanitizeStatusCode, n as createDefu, o as getContext, q as createHooks, r as toRouteMatcher, v as createRouter$1, w as parse$1, x as getRequestHeader, y as getRequestHeaders, z as destr, A as isEqual$1, B as setCookie, C as getCookie, D as deleteCookie } from '../_/nitro.mjs';
...
import { faSliders, faMagnifyingGlass, faMoneyBill, faBed, faWarehouse, faBath, faRulerCombined, faLocationPin, faBuilding, faXmark, faBars, faPhone, faClock } from '@fortawesome/free-solid-svg-icons';
...
const _routes = [
  {
    name: "404",
    path: "/404",
    component: () => import('./404-BVp0HaMZ.mjs')
  },
  {
    name: "inmueble-name-id",
    path: "/inmueble/:name()-:id()",
    component: () => import('./_name_-_id_-CQrQcxC3.mjs')
  },
  {
    name: "propiedades-business",
    path: "/propiedades/:business()",
    meta: __nuxt_page_meta,
    component: () => import('./_business_-BncQ3Cjm.mjs')
  }
];
...
const namedMiddleware = {
  propiedades: () => import('./propiedades-DvpImWTC.mjs')
};
...
const LazyIcon = defineAsyncComponent(() => import('./index-Bg46Vx3Y.mjs').then((r) => r["default"] || r.default || r));
...
const viewportOptions = { "breakpoints": { "desktop": 721, "tablet": 720, "mobile": 600 }, "cookie": { "expires": 365, "name": "viewport", "path": "/", "sameSite": "Strict", "secure": true }, "defaultBreakpoints": { "desktop": "desktop", "mobile": "mobile", "tablet": "tablet" }, "fallbackBreakpoint": "desktop", "feature": "minWidth" };
const plugin_server_dMhYspXuPp = /* @__PURE__ */ defineNuxtPlugin(async (nuxtApp) => {
  var _a, _b, _c, _d;
  let __temp, __restore;
  const state = useState(STATE_KEY, "$Nx3rdeBeDI");
...
const icons = { freeFasFaSliders: faSliders, freeFasFaMagnifyingGlass: faMagnifyingGlass, freeFasFaMoneyBill: faMoneyBill, freeFasFaBed: faBed, freeFasFaWarehouse: faWarehouse, freeFasFaBath: faBath, freeFasFaRulerCombined: faRulerCombined, freeFasFaLocationPin: faLocationPin, freeFasFaBuilding: faBuilding, freeFasFaXmark: faXmark, freeFasFaBars: faBars, freeFasFaPhone: faPhone, freeFasFaClock: faClock };
config$1.autoAddCss = false;
const fontawesome_7xXmPH2btU = /* @__PURE__ */ defineNuxtPlugin(() => {
  library.add(icons);
});
const clickOutside_ZB3Eg0wOVk = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  nuxtApp.vueApp.directive("click-outside", {
    mounted(el, binding) {
      ...
      (void 0).addEventListener("click", el.clickOutsideHandler);
    },
    unmounted(el) {
      if (el.clickOutsideHandler) {
        (void 0).removeEventListener("click", el.clickOutsideHandler);
      }
    }
  });
});
const api_GFfDXud5Cr = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  ...
  const api = $fetch.create({
    baseURL: config2.public.apiBaseUrl,
...
const uiColorTheme_DjvyYnh9f0 = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const plugins = [
  ...
  api_GFfDXud5Cr,
  uiColorTheme_DjvyYnh9f0
];
const layouts = {
  default: defineAsyncComponent(() => import('./default-OeFeQS-O.mjs'))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-b7YFsNNa.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-_x47esCg.mjs'));
...
export { __nuxt_component_1 as A, _export_sfc as _, useRouter as a, navigateTo as b, useNuxtApp as c, useRuntimeConfig as d, entry$1 as default, withoutTrailingSlash as e, useRequestEvent as f, useRoute as g, hasProtocol as h, useSeoMeta as i, joinURL as j, fetchDefaults as k, useRequestFetch as l, asyncDataDefaults as m, nuxtLinkDefaults as n, createError as o, parseQuery as p, mergeConfig as q, resolveRouteObject as r, appConfig as s, useAppConfig as t, useHead as u, get as v, withTrailingSlash as w, omit as x, defineNuxtRouteMiddleware as y, abortNavigation as z };
